<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Usulan Majalah</h1>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-sm-8">
          ...
          <div class="table-responsive">
              ...
              <th scope="col">Aksi</th>
                  ...
                  <td><?= $bk['tahun']; ?></td>
				  				<td>
				  					<a class="btn btn-sm btn-success mb-1 mx-1" href="<?= base_url(); ?>petugas_buku/konfirmasi_majalah/<?=$bk['id_koleksi']; ?>"><div><i class="far fa-check-circle"></i> Tambahkan</div></a>
                      <a class="btn btn-sm btn-danger mb-1 mx-1" href="<?=base_url();?>petugas_buku/hapus_usulan_majalah/<?=$bk['id_koleksi']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus ?');"><div><i class="fa fa-trash"></i> Hapus</div></a>
						      </td>
				  				</td>
				  			</tr>
				  		<?php endforeach; ?>

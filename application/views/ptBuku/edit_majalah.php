              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-center text-lg font-weight-bold text-primary text-uppercase mb-1">Edit Majalah</div>
                      <form  action="<?= base_url(); ?>petugas_buku/edit_majalah/<?= $detail['id_koleksi']; ?>"method="post" enctype="multipart/form-data">
	                     <div class="form-group">
							    <label for="nis">Judul Majalah</label>
						   ...
						   <div class="form-group">
							    <label for="nama">Jumlah Majalah</label>

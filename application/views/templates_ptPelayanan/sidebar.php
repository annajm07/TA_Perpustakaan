  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item <?php if($judul == 'Beranda'):?>active<?php endif; ?>">
        <a class="nav-link" href="<?= base_url(); ?>Petugas_pelayanan">
      ...
      <li class="nav-item <?php if($judul == 'Lihat Profil'||$judul == 'Ganti Password'||$judul == 'Ganti Foto'):?>active<?php endif; ?>">
        ...
        <div id="pengguna" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url(); ?>petugas_pelayanan/lihat_profil"><i class="fas fa-square"></i> Lihat Profil</a>
            <a class="collapse-item" href="<?= base_url(); ?>petugas_pelayanan/ganti_foto"><i class="fas fa-square"></i> Ganti Foto Profil</a>
            <a class="collapse-item" href="<?= base_url(); ?>petugas_pelayanan/ganti_password"><i class="fas fa-square"></i> Ganti Password</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item <?php if($judul == 'Buku'||$judul == 'Data Jurnal'||$judul == 'Data Majalah'||$judul == 'Data Surat Kabar'||$judul == 'Detail Buku'||$judul == 'Detail Surat Kabar'||$judul == 'Detail Majalah'||$judul == 'Detail Jurnal'||$judul == 'Edit Buku'||$judul == 'Edit Jurnal'||$judul == 'Edit Majalah'||$judul == 'Edit Surat Kabar'):?>active<?php endif; ?>">
        ...
        <div id="buku" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <!-- <h6 class="collapse-header">Custom Components:</h6> -->
            <a class="collapse-item" href="<?= base_url(); ?>petugas_pelayanan/buku"><i class="fas fa-square"></i> Buku</a>
            <a class="collapse-item" href="<?= base_url(); ?>petugas_pelayanan/data_jurnal"><i class="fas fa-square"></i> Jurnal</a>
            <a class="collapse-item" href="<?= base_url(); ?>petugas_pelayanan/data_majalah"><i class="fas fa-square"></i> Majalah</a>
            <a class="collapse-item" href="<?= base_url(); ?>petugas_pelayanan/data_surat_kabar"><i class="fas fa-square"></i> Surat Kabar</a>
          </div>
        </div>
      </li>
       ...
       <li class="nav-item <?php if($judul == 'Peminjaman'||$judul == 'Sedang Meminjam'||$judul == 'Pengembalian'||$judul == 'Riwayat Transaksi Siswa'||$judul == 'Riwayat Transaksi Guru'):?>active<?php endif; ?>">
        ...
        <div id="transaksi" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <!-- <h6 class="collapse-header">Custom Components:</h6> -->
            <a class="collapse-item" href="<?= base_url(); ?>petugas_pelayanan/konfirmasi_peminjaman"><i class="fas fa-square"></i> Peminjaman</a>
            <a class="collapse-item" href="<?= base_url(); ?>petugas_pelayanan/daftar_peminjam"><i class="fas fa-square"></i> Sedang Meminjam</a>
            <a class="collapse-item" href="<?= base_url(); ?>petugas_pelayanan/konfirmasi_pengembalian"><i class="fas fa-square"></i> Pengembalian</a>
            <a class="collapse-item" href="<?= base_url(); ?>petugas_pelayanan/riwayat_siswa"><i class="fas fa-square"></i> Riwayat Transaksi Siswa</a>
            <a class="collapse-item" href="<?= base_url(); ?>petugas_pelayanan/riwayat_guru"><i class="fas fa-square"></i> Riwayat Transaksi Guru</a>
          </div>
        </div>
      </li>

      <li class="nav-item <?php if($judul == 'Kritik dan Saran'):?>active<?php endif; ?>">
        <a class="nav-link" href="<?= base_url(); ?>petugas_pelayanan/kritik_saran">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Navbar -->
          <ul class="navbar-nav">
            <li class="mt-auto"> Role : Petugas Pelayanan</li>
          </ul>
          ...
          <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown no-arrow">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                  <a class="dropdown-item" href="<?= base_url(); ?>Petugas_pelayanan/lihat_profil">

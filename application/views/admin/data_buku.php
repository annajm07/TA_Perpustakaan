        ...
        <div class="container-fluid">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="mx-1">
                <a target="_blank" href="<?= base_url(); ?>admin/cetak_buku" class="btn btn-danger"><i class="fa fa-print"></i> Cetak</a>
              </div>
              <div class="mx-1">
              <a href="<?= base_url(); ?>admin/buku_pdf" class="btn btn-warning"><i class="fa fa-file"></i> Export PDF</a>
              </div>
          	</div>
          <div class="table-responsive">
                  ...
                  <th scope="col">Tahun</th>
                      ...
                      <td><?= $bk['kategori']; ?></td>
    				  				<td><?= $bk['tahun']; ?></td>
    				  				<td>
    				  					<a class="btn btn-sm btn-primary mb-1" href="<?= base_url(); ?>admin/detail_buku/<?= $bk['id_koleksi']; ?>"><div style="width: 20px;"><i class="fas fa-search-plus"></i></div></a>
    						      		<a class="btn btn-sm btn-success mb-1" href="<?= base_url(); ?>admin/edit_buku/<?= $bk['id_koleksi']; ?>"><div style="width: 20px;"><i class="fa fa-edit"></i></div></a>
    						      		<a class="btn btn-sm btn-danger mb-1" onclick="return confirm('Apakah anda yakin ingin menghapus ?');" href="<?= base_url(); ?>admin/hapus_buku/<?= $bk['id_koleksi']; ?>"><div style="width: 20px;"><i class="fa fa-trash"></i></div></a>
    						      </td>
    				  				</td>
    				  			</tr>
    				  		<?php endforeach; ?>
...
<div class="modal fade" id="modal_buku" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <form action="<?= base_url(); ?>admin/data_buku">

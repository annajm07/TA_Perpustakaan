              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-center text-lg font-weight-bold text-primary text-uppercase mb-1">Detail Siswa</div>
                      ...
                      <div class="form-group">
					   ...
					   <div class="form-group">
						    ...
						    <input readonly="" type="text" class="form-control" value="<?= $detail['jurusan']; ?>">
					   </div>
					   <div class="form-group">
						    <label for="exampleInputEmail1">Kelas</label>
						    <input readonly="" type="text" class="form-control" value="<?= $detail['kelas']; ?>">
					   </div>
					   <div class="form-group">
					   ...
					   <a class="btn btn-success float-right" href="<?= base_url(); ?>admin/data_siswa"><i class="fas fa-arrow-left"></i> Kembali</a>
                    </div>

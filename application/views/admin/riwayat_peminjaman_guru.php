<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <div class="row mb-2">
          	<div class="mx-1">
          		<a target="_blank" href="<?= base_url(); ?>admin/cetak_transaksi_guru" class="btn btn-danger"><i class="fa fa-print"></i> Cetak</a>
          	</div>
          	<div>
          		<a  href="<?= base_url(); ?>admin/transaksi_guru_pdf" class="btn btn-warning"><i class="fa fa-file"></i> Export PDF</a>
          	</div>
          </div>

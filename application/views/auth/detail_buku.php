<div class="container mt-5">
	...
	<div class="row mb-5">
		<div class="col-sm-7 m-auto mb-4">
              <div class="card border-left-none shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
					  ...
					  <a class="btn btn-success float-right" href="<?= base_url(); ?>Auth/koleksi_buku"><i class="fas fa-arrow-left"></i> Kembali</a>
                    </div>

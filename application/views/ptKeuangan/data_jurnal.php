        ...
        <div class="container-fluid">
          ...
          <div class="table-responsive">
              ...
              <th scope="col">Aksi</th>
                  ...
                  <td><?= $bk['tahun']; ?></td>
				  				<td>
				  					<a class="btn btn-sm btn-primary mb-1" href="<?= base_url(); ?>petugas_keuangan/detail_jurnal/<?= $bk['id_koleksi']; ?>"><div style="width: 20px;"><i class="fas fa-search-plus"></i></div></a>

                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
					  ...
					  <a class="btn btn-danger float-left" href="<?= base_url(); ?>siswa/buku"><i class="fas fa-arrow-left"></i> Kembali</a>

					   <a class="btn btn-success float-right" href="<?= base_url(); ?>siswa/pinjam/<?=$detail['id_koleksi']; ?>"><i class="fas fa-share-square"></i> Pinjam</a>
                    </div>

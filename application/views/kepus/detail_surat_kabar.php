              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-center text-lg font-weight-bold text-primary text-uppercase mb-1">Detail Surat Kabar</div>
                      <div class="mb-2"><img width="65px;" src="<?= base_url(); ?>assets/img/buku/<?= $detail['gambar']; ?>"></div>
                      <div class="form-group">
						    <label for="exampleInputEmail1">Judul Surat Kabar</label>
					    ...
					    <div class="form-group">
						    <label for="exampleInputEmail1">Jumlah Surat Kabar</label>
					   ...
					   <a class="btn btn-success float-right" href="<?= base_url(); ?>kepala_perpustakaan/data_surat_kabar"><i class="fas fa-arrow-left"></i> Kembali</a>
                    </div>

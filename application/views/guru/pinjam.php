                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <form  action="<?= base_url(); ?>guru/proses_pinjam" method="post">
	                     <div class="form-group">
							    <label for="nis">ID Guru</label>
							    <input readonly="" type="text" class="form-control" name="id_guru" value="<?= $guru['id_anggota']; ?>">
						   </div>
						   <div class="form-group">
						   ...
						   <div class="form-group">
							    ...
							    <input readonly="" type="text" class="form-control" name="nama" value="<?= $guru['nama_anggota']; ?>">
						   </div>
						   <div class="form-group">
